...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Full Stack Developer for Hire | React, Next.js & Node.js Expert',
  ...
  openGraph: {
    ...
    title: 'Full Stack Developer for Hire | React, Next.js & Node.js Expert',
    description: siteConfig.description,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Kazi Shariful Islam — Full Stack Developer for Hire',
      },
    ],
  },
  twitter: {
