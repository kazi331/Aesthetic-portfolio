          ...
          <div className="pt-6">
            ...
            <div className="w-full flex flex-col gap-3 mb-4">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="font-mono text-[9px] text-muted-text/80 uppercase">
                  Domain Filter
                </span>
              </div>
                ...
                {(['all', 'frontend', 'backend', 'database', 'tooling'] as const).map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] font-mono font-bold uppercase tracking-wider transition-all cursor-pointer active:scale-95 ${
                        isSelected
                    ...
                    >
                      ...
                      <span
                        className={`text-[8px] px-1.5 py-0.2 rounded-full ${
                          isSelected
                            ? 'bg-[#4E85BF]/25 text-white'
                            : 'bg-white/5 text-muted-text/70'
                        }`}
                      >
                        {count}
                      </span>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span
                              className={`w-1.5 h-1.5 rounded-full ${
                                isCore ? 'bg-[#4E85BF]' : isData ? 'bg-[#10B981]' : 'bg-yellow-500'
                              }`}
                            />
                          </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <ChevronDown
                          className={`w-4 h-4 text-muted-text transition-transform duration-200 ease-out will-change-transform ${
                            isSelected ? 'rotate-180 text-[#89AACC]' : 'rotate-0'
                          }`}
                        />
                      </div>
                    </div>
