...
export const services: Service[] = [
  ...
  },
  {
    ...
    title: 'Node.js & NestJS API Engineering',
  ...
  {
    id: 'shopify-apps',
    title: 'Shopify Apps & Custom Functions',
    description: 'Architecting high-performance custom Shopify integrations and App Store solutions. Authoring sub-5ms WebAssembly Shopify Functions for dynamic discount transformations.',
    iconName: 'Sparkles',
    capabilities: [
      'Shopify Functions (Rust / Node.js WASM)',
      'GraphQL Admin & Storefront API',
      'PostgreSQL Merchant Settings Sync',
      'Polaris Admin Embed Dashboards',
    ],
  }
];
...
[Hire me for your next project](#contact-cta) or [schedule an architecture consultation](https://calendly.com).
`
  },
  {
...
[Explore my engineering case studies](#featured-projects) or [hire me for your technical roadmap](#contact-cta).
`
  },
  {
